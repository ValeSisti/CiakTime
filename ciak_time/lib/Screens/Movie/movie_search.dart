...
class _MovieSearchState extends State<MovieSearch> {
  ...
  void initState() {
    ...
    bloc_details = MovieDetailsBloc(movieSelectedFromSearch.id.toString());
                                    ...
                                    if (alreadyWatchedListTitle ==
                                      ...
                                      if (isContainedInWatchList == 1) {
                                        ...
                                        await addMovieToDBList(
                                            ...
                                            movieSelectedFromSearch.voteAverage,
                                            movieSelectedFromSearch.releaseDate,
                                            movieSelectedFromSearch.posterPath,
                ...
                children: <Widget>[
                  ...
                  Row(
                    children: [
                      ...
                      FutureBuilder(
                          future: Future.wait([
                            isMovieSeenIcon(movieSelectedFromSearch),
                            isMovieSeenColor(movieSelectedFromSearch)
                          ]),
                          builder: (BuildContext context,
                      ...
                      SizedBox(width: width * 0.02),
                      FutureBuilder(
                          future: isMovieSeen(movieSelectedFromSearch),
                          builder: (BuildContext context,
                  ...
                  MovieOverviewWidget(movieId: movieSelectedFromSearch.id),
                  TrailerWidget(movieId: movieSelectedFromSearch.id),
                  SizedBox(
                    height: height * 0.01,
                  ),
                  Divider(color: themeDividerColor),
                  ...
                  WatchProvidersList(movieSelected: movieSelectedFromSearch),
                  SizedBox(
                    height: height * 0.01,
                  ),
                  Divider(color: themeDividerColor),
  ...
  Future<double> getRating() async {
    ...
    if (values != null) {
      values.forEach((key, value) {
        if (value["movieId"] == movieSelectedFromSearch.id) {
    ...
    if (values != null) {
      values.forEach((key, value) {
        if (value["userId"] == userId &&
            value["movieId"] == movieSelectedFromSearch.id) {
          reviewInDb = true;
...
class _MovieCoverState extends State<MovieCover> {
  ...
  @override
  void initState() {
    bloc = MovieImagesBloc(movieSelectedFromSearch.id.toString());
...
checkDisabledButton(context) async {
  int isContained = await checkMovieInList(
      "alreadyWatched", userId, movieSelectedFromSearch.id);
  if (isContained == 1) {
    Fluttertoast.showToast(
    ...
    if (watchListTitle == language.remove_watchlist) {
      await deleteMovieFromDBList(
          "watchList", userId, movieSelectedFromSearch.id);
...
class _MovieDurationState extends State<MovieDuration> {
  ...
  @override
  void initState() {
    bloc = MovieDetailsBloc(movieSelectedFromSearch.id.toString());
