...
class _MovieHomeState extends State<MovieHome> {
  ...
  void initState() {
    ...
    bloc_details = MovieDetailsBloc(movieSelectedFromHome.id.toString());
                                    ...
                                    if (alreadyWatchedListTitle ==
                                      ...
                                      int isContainedInWatchList =
                                          await checkMovieInList("watchList",
                                              userId, movieSelectedFromHome.id);
                                      if (isContainedInWatchList == 1) {
                                        ...
                                        await addMovieToDBList(
                                            ...
                                            movieSelectedFromHome.voteAverage,
                                            movieSelectedFromHome.releaseDate,
                                            movieSelectedFromHome.posterPath,
                                            movieSelectedFromHome.voteCount);
                                        buildFlutterToast(language
            ...
            return Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                    ...
                    children: [
                      ...
                      FutureBuilder(
                          future: Future.wait([
                            ...
                            isMovieSeenColor(movieSelectedFromHome)
                          ]),
                          builder: (BuildContext context,
                      ...
                      SizedBox(width: width * 0.02),
                      FutureBuilder(
                          future: isMovieSeen(movieSelectedFromHome),
                          builder: (BuildContext context,
                  ...
                  MovieOverviewWidget(movieId: movieSelectedFromHome.id),
                  TrailerWidget(movieId: movieSelectedFromHome.id),
                  SizedBox(
                    height: height * 0.01,
                  ),
                  Divider(color: themeDividerColor),
                  ...
                  WatchProvidersList(movieSelected: movieSelectedFromHome),
                  SizedBox(
                    height: height * 0.01,
                  ),
                  Divider(color: themeDividerColor),
                  ...
                  MovieCastList(
                      movieSelected: movieSelectedFromHome, fromWhere: "Home"),
                  Divider(color: themeDividerColor),
  ...
  Future<double> getRating() async {
    ...
    if (values != null) {
      values.forEach((key, value) {
        if (value["movieId"] == movieSelectedFromHome.id) {
    ...
    if (values != null) {
      values.forEach((key, value) {
        if (value["userId"] == userId &&
            value["movieId"] == movieSelectedFromHome.id) {
          reviewInDb = true;
...
class _MovieCoverState extends State<MovieCover> {
  ...
  @override
  void initState() {
    bloc = MovieImagesBloc(movieSelectedFromHome.id.toString());
...
checkDisabledButton(context) async {
  int isContained = await checkMovieInList(
      "alreadyWatched", userId, movieSelectedFromHome.id);
  if (isContained == 1) {
    Fluttertoast.showToast(
    ...
    if (watchListTitle == language.remove_watchlist) {
      await deleteMovieFromDBList(
          "watchList", userId, movieSelectedFromHome.id);

      buildFlutterToast(
        language.remove_watchlist_toast,
      );
      Navigator.pop(context);
    } else {
      await addMovieToDBList(
...
class _MovieDurationState extends State<MovieDuration> {
  ...
  @override
  void initState() {
    bloc = MovieDetailsBloc(movieSelectedFromHome.id.toString());
